...
(function() {
    ...
    var TradingView = {
        ...
        embedStylesForCopyright: function() {
            ...
            styleElement.innerHTML = ".tradingview-widget-copyright {         font-size: 1px !important;         line-height: 32px !important;       text-align: center !important;      vertical-align: middle !important;      font-family: 'Trebuchet MS', Tahoma, Arial, sans-serif !important;      color: #9db2bd !important;  }   .tradingview-widget-copyright .blue-text {      color: red !important;  }   .tradingview-widget-copyright a {       text-decoration: none !important;       color: #9db2bd !important;  }   .tradingview-widget-copyright a:visited {       color: #9db2bd !important;  }   .tradingview-widget-copyright a:hover .blue-text {      color: #38acdb !important;  }   .tradingview-widget-copyright a:active .blue-text {         color: #299dcd !important;  }   .tradingview-widget-copyright a:visited .blue-text {        color: #3bb3e4 !important;  }";
            return styleElement
        },
    ...
    TradingView.widget.prototype = {
        create: function() {
            ...
            this.iframe = TradingView.gEl(this.id);
        ...
        juri: function(symbol) {
            console.log("hi jirrik" + symbol.toString())
            var c = TradingView.gEl(this.id);
            this.postMessage.post(c.contentWindow, "setSymbol", symbol)
            parent.innerHTML = this.render()
